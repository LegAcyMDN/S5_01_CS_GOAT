...
namespace S5_01_App_CS_GOAT.Migrations
{
    ...
    [Migration("20260109133356_WearClass")]
    partial class WearClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("S5_01_App_CS_GOAT.Models.EntityFramework.FairRandom", b =>
                {
                    ...
                    b.Property<double?>("Fraction1")
                        .HasColumnType("double precision")
                        .HasColumnName("frn_fraction1");

                    b.Property<double?>("Fraction2")
                        .HasColumnType("double precision")
                        .HasColumnName("frn_fraction2");
            ...
            modelBuilder.Entity("S5_01_App_CS_GOAT.Models.EntityFramework.WearClass", b =>
                {
                    b.Property<int>("SkinId")
                        .HasColumnType("integer")
                        .HasColumnName("skn_id");
                    ...
                    b.HasKey("SkinId", "WearTypeId");

                    b.HasIndex("WearTypeId");

                    b.ToTable("t_j_wearclass_wrc");
                });
            ...
            modelBuilder.Entity("S5_01_App_CS_GOAT.Models.EntityFramework.PriceHistory", b =>
                {
                    ...
                    b.HasOne("S5_01_App_CS_GOAT.Models.EntityFramework.WearClass", "WearClass")
                        .WithMany("PriceHistories")
                        .HasForeignKey("SkinId", "WearTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_pricehistory_wearclass");

                    b.Navigation("Skin");

                    b.Navigation("WearClass");
